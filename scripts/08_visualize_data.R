...
dashboard_html <- tags$html(
  tags$head(
    ...
    ")),
    # Crucial JS snippet forces Leaflet to recalculate map dimensions upon tab change
    tags$script(HTML("
...
# 8. Save output via htmltools::save_html instead of htmlwidgets::saveWidget
