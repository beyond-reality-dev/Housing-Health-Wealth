...
| SDAT Property Sales | 2018–2025 | Property (geocoded to tract) | Public ([Maryland SDAT](https://sdat.dat.maryland.gov/RealProperty/Pages/default.aspx)) |
...
- A token for the Socrata API to access SDAT data (register at [Socrata's website](https://support.socrata.com/hc/en-us/articles/210138558-Generating-App-Tokens-and-API-Keys)), pasted into a file named `socrata.key` in the root directory of the project.
